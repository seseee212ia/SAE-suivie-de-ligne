...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'serializer'.\DIRECTORY_SEPARATOR.'OperationResourceClassResolverInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'serializer'.\DIRECTORY_SEPARATOR.'OperationResourceClassResolver.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'doctrine-orm'.\DIRECTORY_SEPARATOR.'Serializer'.\DIRECTORY_SEPARATOR.'DoctrineOrmOperationResourceClassResolver.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'metadata'.\DIRECTORY_SEPARATOR.'Operation'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'CacheOperationMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'jsonld'.\DIRECTORY_SEPARATOR.'OperationContextBuilderInterface.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'doctrine-orm'.\DIRECTORY_SEPARATOR.'Metadata'.\DIRECTORY_SEPARATOR.'Resource'.\DIRECTORY_SEPARATOR.'DoctrineOrmParameterResourceMetadataCollectionFactory.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'ObjectVariableCheckerInterface.php';
    ...
    {
        return $container->services['api_platform.cache.metadata.operation'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WHZdJLn9rM', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yAniz++bLB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xy6x2lBMY6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NtVl9ShR41', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kbaNUn0hnC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('plpXx7Hhj1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityListenerResolverService($container)
    {
        $container->services['doctrine.orm.default_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerEntityListenerResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\EventListener\\RenduListener' => ['privates', 'App\\EventListener\\RenduListener', 'getRenduListenerService', true],
        ], [
            'App\\EventListener\\RenduListener' => '?',
        ]));

        $instance->registerService('App\\EventListener\\RenduListener', 'App\\EventListener\\RenduListener');
    ...
    protected static function get_ServiceLocator_Z7e86QUService($container)
    {
        ...
        if (isset($container->privates['.service_locator.z7e86QU'])) {
            return $container->privates['.service_locator.z7e86QU'];
        }

        return $container->privates['.service_locator.z7e86QU'] = $instance;
    }
    ...
    {
        $instance = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_sae_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_sae_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntitySaeApiPlatformDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_sae_api_platform_doctrine_orm_filter_search_filter' => '?',
        ]);
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8exe+Rq6n4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        $instance = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'vich_uploader.listener.clean.rendus' => ['privates', 'vich_uploader.listener.clean.rendus', 'getVichUploader_Listener_Clean_RendusService', true],
            ...
            'vich_uploader.listener.remove.rendus' => ['privates', 'vich_uploader.listener.remove.rendus', 'getVichUploader_Listener_Remove_RendusService', true],
            'vich_uploader.listener.upload.rendus' => ['privates', 'vich_uploader.listener.upload.rendus', 'getVichUploader_Listener_Upload_RendusService', true],
        ], [
            'vich_uploader.listener.clean.rendus' => '?',
            ...
            'vich_uploader.listener.remove.rendus' => '?',
            'vich_uploader.listener.upload.rendus' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.rendus'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.rendus'], [['postFlush'], 'vich_uploader.listener.remove.rendus'], [['prePersist'], 'vich_uploader.listener.upload.rendus'], [['preUpdate'], 'vich_uploader.listener.upload.rendus']]);
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\EnseignantsRepository' => ['privates', 'App\\Repository\\EnseignantsRepository', 'getEnseignantsRepositoryService', true],
            'App\\Repository\\EtudiantsRepository' => ['privates', 'App\\Repository\\EtudiantsRepository', 'getEtudiantsRepositoryService', true],
            ...
            'App\\Repository\\RenduRepository' => ['privates', 'App\\Repository\\RenduRepository', 'getRenduRepositoryService', true],
            'App\\Repository\\SAERepository' => ['privates', 'App\\Repository\\SAERepository', 'getSAERepositoryService', true],
            'App\\Repository\\TitreRepository' => ['privates', 'App\\Repository\\TitreRepository', 'getTitreRepositoryService', true],
        ], [
            'App\\Repository\\AdminRepository' => '?',
            'App\\Repository\\DocumentsRepository' => '?',
            'App\\Repository\\EnseignantsRepository' => '?',
            'App\\Repository\\EtudiantsRepository' => '?',
            'App\\Repository\\GroupeRepository' => '?',
            'App\\Repository\\NotificationsRepository' => '?',
            'App\\Repository\\RenduRepository' => '?',
            'App\\Repository\\SAERepository' => '?',
    ...
    protected static function getSerializerService($container)
    {
        ...
        $q = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $e, $n, $f, $j, $m, $o, $container->parameters['api_platform.serializer.default_context'], $g, NULL, $h, $p);
        ...
        $t = new \ApiPlatform\Serializer\ItemNormalizer($c, $d, $e, $n, $j, $m, $o, NULL, $b, $g, [], NULL, $p);
        $u = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($o);
        $v = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($o);
        $w = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $m, $j, $a, $v, NULL, [], $a);
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($j), $l, $l, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $m), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $m, $container->parameters['api_platform.serializer.default_context']), $l, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $m), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $n, $s, $m, $container->parameters['api_platform.serializer.default_context'], true), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $e, $s), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($t, $m), $r, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $q, $t, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $u), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $u, $a, $v, NULL, [])), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $n, $e, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $j, 1, $container->parameters['api_platform.serializer.default_context']), $b, $n, $i, $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($w, $e, $f), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $u, $j, $a, $v, NULL, $container->parameters['api_platform.serializer.default_context'], $a), $w], [new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $k, $x, new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $x), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')], $container->parameters['api_platform.serializer.default_context']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'Portail Universitaire - Gestion des SAE',
            ...
            'api_platform.class_name_resources' => [
                ...
                2 => 'App\\Entity\\Admin',
                3 => 'App\\Entity\\Documents',
                4 => 'App\\Entity\\Enseignants',
                5 => 'App\\Entity\\Etudiants',
                6 => 'App\\Entity\\Groupe',
                7 => 'App\\Entity\\Notification',
            ...
            'vich_uploader.mappings' => [
                'rendus' => [
                    'uri_prefix' => '/uploads/rendus',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/rendus'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.rendus',
                        'options' => [
