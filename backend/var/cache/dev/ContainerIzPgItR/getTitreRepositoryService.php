 ...
 */
class getTitreRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TitreRepository.php';

        return $container->privates['App\\Repository\\TitreRepository'] = new \App\Repository\TitreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
