 ...
 */
class getSAERepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SAERepository' shared autowired service.
     *
     * @return \App\Repository\SAERepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SAERepository.php';

        return $container->privates['App\\Repository\\SAERepository'] = new \App\Repository\SAERepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
