 ...
 */
class getVichUploader_Listener_Remove_RendusService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.rendus' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.rendus'])) {
            return $container->privates['vich_uploader.listener.remove.rendus'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('rendus', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);

        if (isset($container->privates['vich_uploader.listener.remove.rendus'])) {
            return $container->privates['vich_uploader.listener.remove.rendus'];
        }

        return $container->privates['vich_uploader.listener.remove.rendus'] = $instance;
    }
}
