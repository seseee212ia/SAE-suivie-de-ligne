 ...
 */
class getRenduRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RenduRepository' shared autowired service.
     *
     * @return \App\Repository\RenduRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RenduRepository.php';

        return $container->privates['App\\Repository\\RenduRepository'] = new \App\Repository\RenduRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
