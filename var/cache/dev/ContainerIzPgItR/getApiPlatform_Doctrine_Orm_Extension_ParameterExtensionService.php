...
class getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'doctrine-common'.\DIRECTORY_SEPARATOR.'ParameterExtensionTrait.php';
        ...
        $instance = new \ApiPlatform\Doctrine\Orm\Extension\ParameterExtension($a, ($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)));

        if (isset($container->privates['api_platform.doctrine.orm.extension.parameter_extension'])) {
            return $container->privates['api_platform.doctrine.orm.extension.parameter_extension'];
        }

        return $container->privates['api_platform.doctrine.orm.extension.parameter_extension'] = $instance;
    }
}
