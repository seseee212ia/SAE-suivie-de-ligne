 ...
 */
class getEnseignantsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnseignantsRepository' shared autowired service.
     *
     * @return \App\Repository\EnseignantsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnseignantsRepository.php';

        return $container->privates['App\\Repository\\EnseignantsRepository'] = new \App\Repository\EnseignantsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
