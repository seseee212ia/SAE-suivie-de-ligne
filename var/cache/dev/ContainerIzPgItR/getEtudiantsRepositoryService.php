 ...
 */
class getEtudiantsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EtudiantsRepository' shared autowired service.
     *
     * @return \App\Repository\EtudiantsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EtudiantsRepository.php';

        return $container->privates['App\\Repository\\EtudiantsRepository'] = new \App\Repository\EtudiantsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
