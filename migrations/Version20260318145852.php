 ...
 */
final class Version20260318145852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rendu (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, date DATE NOT NULL, sae_id INT NOT NULL, etudiant_id INT DEFAULT NULL, groupe_id INT NOT NULL, INDEX IDX_2A7F8EB9DDE9B22 (sae_id), INDEX IDX_2A7F8EB9DDEAB1A3 (etudiant_id), INDEX IDX_2A7F8EB97A45358C (groupe_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
